    ...
    return (
        <div className='pa'>
            ...
            <div className='figure-hold3'>
                <p className='val'> {price1} Dh  </p>

                <p className='val'> {numOfDays} days </p>

                <p className='val'> guest</p>
            </div>
            ...
            <div className='totalCard2 flex gap-4 bg-white font-semibold'>
                <p>TOTAL</p>
                <p>{(price1 * numOfDays) + 240 + 65}Dh</p>
            </div>

            <div className="hello2 flex flex-col absolute gap-3 bg-white italic  text-lg">
                <p>Hello our beautiful guest</p>

                <p>You Are About To Pay {(price1 * numOfDays) + 240 + 65}Dh </p>
            </div>
