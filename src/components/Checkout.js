  ...
  return (
    <div className='checkout-parent'>
      ...
      <div className='place-datails-container absolute'>
        ...
        <p className='checkout-start-price font-semibold'>{price}Dh</p>
        ...
        <p className='absolute total-checkout'>{240 + 65 + (price * daysFinal)}Dh</p>
        <br />
        <br />
        <br />
